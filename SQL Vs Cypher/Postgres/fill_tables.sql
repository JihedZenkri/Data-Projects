...
/* alimentation des tables à partir des fichirs CSV */

/* n'oubliez pas de remplacer le path absolue !! " */ 

COPY employees 
FROM 'C:\Users\imad\Desktop\projet bds\project\postgres\employees.csv'
WITH DELIMITER ','  NULL AS '' CSV HEADER;

COPY categories
FROM 'C:\Users\imad\Desktop\projet bds\project\postgres\categories.csv'
WITH DELIMITER ','  NULL AS '' CSV HEADER;


COPY suppliers
FROM 'C:\Users\imad\Desktop\projet bds\project\postgres\suppliers.csv'
WITH DELIMITER ','  NULL AS '' CSV HEADER;

COPY products
FROM 'C:\Users\imad\Desktop\projet bds\project\postgres\products.csv'
WITH DELIMITER ','  NULL AS '' CSV HEADER;

COPY customers
FROM 'C:\Users\imad\Desktop\projet bds\project\postgres\customers.csv'
WITH DELIMITER ','  NULL AS '' CSV HEADER;
